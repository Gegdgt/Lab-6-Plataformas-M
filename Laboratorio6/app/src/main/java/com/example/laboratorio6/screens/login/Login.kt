...
import com.example.laboratorio6.screens.login.LoginScreenViewModel
            ...
            if (showLoginForm.value){
                ...
                UserForm(
                    isCreateAccount = false
                        ...
                        email, password ->
                        Log.d("Hola ", "Logueado con $email y $password")
                        viewModel.signInWithEmailAndPassword(email, password){
                            navController.navigate(Laboratorio6Screens.GalleryScreen.name)
                        }
                }
            }
            else{
